...
export default function AboutPage() {
  return (
    <div className="flex flex-col w-full py-20 px-6 max-w-[1000px] mx-auto">
      ...
      <div className="bg-white p-8 md:p-12 rounded-2xl border border-gray-100 shadow-sm mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-brand-bg rounded-xl aspect-video border border-brand-light flex items-center justify-center">
          <span className="text-text-muted">Team Photo Placeholder</span>
        </div>
      </div>
