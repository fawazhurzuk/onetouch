    ...
    <div className="w-full max-w-4xl mx-auto py-16 px-4">
      <div className="flex flex-col md:flex-row items-center justify-between relative">
        ...
        >
          ...
          <h3 className="font-bold text-lg text-brand-navy text-center">OneTouch DC</h3>
        ...
        >
          ...
          <h3 className="font-bold text-lg text-brand-navy text-center">OneTouch Retail</h3>
        ...
        >
          ...
          <h3 className="font-bold text-lg text-brand-navy text-center">OneTouch Accounting</h3>
